                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item"><a href="{{ route('index') }}" class="nav-link"><i
                                        class="fa-solid fa-house text-dark icon-sm"></i></a></li>



                            {{-- Messages Dropdown --}}
                            <li class="nav-item dropdown">
                                <a id="messagesDropdown" class="nav-link position-relative" data-bs-toggle="dropdown"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="messagesDropdown"
                                    ...
                                    <li class="dropdown-item text-center">
                                        <a href="{{ route('conversations.index') }}"
                                            class="btn btn-sm btn-outline-primary w-100">View All Conversations</a>
                                    </li>
                                    <li>
                            ...
                            {{-- Create Post --}}
                            <li class="nav-item"><a href="{{ route('post.create') }}" class="nav-link"><i
                                        class="fa-solid fa-circle-plus text-dark icon-sm"></i></a></li>
                        ...
                        <div class="col-3">
                            <div class="list-group">
                                <a href="{{ route('admin.users') }}"
                                    class="list-group-item {{ request()->is('admin/users') ? 'active' : '' }}"><i
                                        class="fa-solid fa-users"></i> Users</a>
                                <a href="{{ route('admin.posts') }}"
                                    class="list-group-item {{ request()->is('admin/posts') ? 'active' : '' }}"><i
                                        class="fa-solid fa-newspaper"></i> Posts</a>
                                <a href="{{ route('admin.categories') }}" class="list-group-item"><i
